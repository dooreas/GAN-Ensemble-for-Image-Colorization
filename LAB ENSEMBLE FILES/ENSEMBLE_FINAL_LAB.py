...
os.makedirs("/Users/doore/Documents/Pix2pix_JAKE/Ensemble_Test", exist_ok=True)
os.makedirs("/Users/doore/Documents/Pix2pix_JAKE/Ensemble_Test/Fakes", exist_ok=True)
os.makedirs("/Users/doore/Documents/Pix2pix_JAKE/Ensemble_Test/Fake_Real_Comparison", exist_ok=True)
...
if __name__ == '__main__':
    ...
    for  category in categ:
        model_save_as = "_LAB_baseline_pix2pix_early_progress"
    ...
    for data in test_dls: #IMPORTANT: BS=1 required.
        ...
        Image.fromarray(fake).save("/Users/doore/Documents/Pix2pix_JAKE/Ensemble_Test/Fakes/"+categ[int(preds)]+"_"+str(i)+".jpg")
        ...
        Image.fromarray(progress_image).save("/Users/doore/Documents/Pix2pix_JAKE/Ensemble_Test/Fake_Real_Comparison/"+categ[int(preds)]+"_"+str(i)+".jpg")
