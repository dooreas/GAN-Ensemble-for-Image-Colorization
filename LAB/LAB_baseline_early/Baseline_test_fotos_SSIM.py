...
#This file corresponds to a light modification of the file used for testing the ensemble numerically and producing the colorization of the images in the test set.
# Now it is used for colorizing the images with the baseline pix2pix model. Notice that we still used the resnet model as in the original file. The reason is that 
# it imposes an ordering of the files which is helpfull for us in order to better compare the images produced with the baseline and with our ensemble 


#The following are the directories where we will save the produced images compared with the real ones and alone
os.makedirs("/Users/doore/Documents/Pix2pix_JAKE/Baseline_Test", exist_ok=True)
os.makedirs("/Users/doore/Documents/Pix2pix_JAKE/Baseline_Test/Fakes", exist_ok=True)
os.makedirs("/Users/doore/Documents/Pix2pix_JAKE/Baseline_Test/Fake_Real_Comparison", exist_ok=True)
...
if __name__ == '__main__':
    ...
    model_save_as = "baseline_pix2pix_without_pretrain_early_progress"
    ...
    for data in test_dls: #IMPORTANT: BS=1 required.
        ...
        Image.fromarray(fake).save("/Users/doore/Documents/Pix2pix_JAKE/Baseline_Test/Fakes/"+categ[int(preds)]+"_"+str(i)+".jpg")
        ...
        Image.fromarray(progress_image).save("/Users/doore/Documents/Pix2pix_JAKE/Baseline_Test/Fake_Real_Comparison/"+categ[int(preds)]+"_"+str(i)+".jpg")
