...
--------------------------
 The file "Ensemble_FINAL_YUV.py" is used to test numerically and give the generated images of our model given the test set. The requirements are the following:
